...
import 'package:donluis_forms/features/plantillas/brix_moscatel/domain/cartilla_brix_moscatel_report_config.dart';
...
import 'package:donluis_forms/features/plantillas/conteo_cargadores/domain/cartilla_conteo_cargadores_report_config.dart';
...
class CartillaReportRegistry {
  ...
  static CartillaReportConfig _resolveSingle(String key, String templateKey) {
    switch (key) {
      ...
      case CartillaBrixMoscatelConfig.templateKeyStatic:
        return cartillaBrixMoscatelReportConfig;
